                ...
                {data &&
                    <div className={classes.header}>
                        ...
                        <div className={classes.titleContainer}>
                            ...
                            <Typography variant="subtitle2" component="h6" className={classes.title}><b>Manager:</b>  {data.report_to_id && `${data.manager.fst_name} ${data.manager.last_name}`}</Typography>
                        </div>
                    </div>
                }
            </React.Fragment>
